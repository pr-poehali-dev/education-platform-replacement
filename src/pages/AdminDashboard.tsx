...
interface AdminDashboardProps {
  ...
  onManageListeners: () => void;
}

export default function AdminDashboard({ user, onLogout, onSwitchToListener, onManageListeners }: AdminDashboardProps) {
  ...
  const finishTest = () => {
    ...
    const protocol = {
      ...
      student: user.name,
      studentPosition: user.role === 'ot' ? 'Инженер по охране труда' : 'Инженер по пожарной безопасности',
  ...
  const departmentName = user.role === 'ot' ? 'Охрана труда' : 'Пожарная безопасность';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Панель администратора — {departmentName}</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <Button onClick={onManageListeners} variant="outline" className="hidden md:flex">
                <Icon name="Users" className="h-4 w-4 mr-2" />
                Управление слушателями
              </Button>
              <Button onClick={onSwitchToListener} variant="outline" className="hidden md:flex">
                <Icon name="ArrowRightLeft" className="h-4 w-4 mr-2" />
                Страница слушателя
              </Button>
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="grid md:grid-cols-4 gap-4 mb-8">
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardDescription>Активных слушателей</CardDescription>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
            ...
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-muted-foreground">Готовые курсы по различным направлениям ОТ и ПБ</p>
                </div>
          ...
          <TabsContent value="testing">
            <TestingInterface
              ...
              currentUser={{ name: user.name, role: 'admin', position: departmentName }}
            />
          </TabsContent>
